...
import com.example.dormsuser.databinding.ActivityBreakfastBinding;
...
public class BreakfastActivity extends AppCompatActivity {
    ...
    void setUpRange(){
        ...
        binding.calendarView.setMinimumDate(startCal);
        endCal.add(Calendar.DAY_OF_MONTH,8);
        binding.calendarView.setMaximumDate(endCal);
        ...
        binding.calendarView.setOnDayClickListener(new OnDayClickListener() {
            ...
            public void onDayClick(EventDay eventDay) {
                if(IS_FETCHED){
                    ...
                    Intent intent = new Intent(BreakfastActivity.this,MenuSelectActivity.class);
                    ...
                    Toast.makeText(BreakfastActivity.this, "Wait a moment..", Toast.LENGTH_SHORT).show();
                }
            }
        });
