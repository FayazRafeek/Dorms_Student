...
import com.example.dormsuser.databinding.ActivityLunchBinding;
...
public class LunchActivity extends AppCompatActivity {
        ...
        binding.calendarView.setOnDayClickListener(new OnDayClickListener() {
            ...
            public void onDayClick(EventDay eventDay) {
                if(IS_FETCHED){
                    ...
                    Intent intent = new Intent(LunchActivity.this,MenuSelectActivity.class);
                    ...
                    Toast.makeText(LunchActivity.this, "Wait a moment..", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    void updateEvents(List<MenuSelection> list){
        ...
        for (MenuSelection m : list){
            Log.d("333", "  updateEvents: " + m.getMenuDate());
